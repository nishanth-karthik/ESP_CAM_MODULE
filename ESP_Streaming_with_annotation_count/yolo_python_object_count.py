...
#url = 'http://192.168.X.X/cam-hi.jpg'  # Replace with your ESP32-CAM IP
...
def findObject(outputs, im):
    ...
    # Dictionary to count object occurrences
    ...
    if len(indices) > 0:
        ...
        for i in indices:
            ...
            cv2.putText(im, f'{label.upper()} {confidence}%', (x, y - 10),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 0, 255), 2)

    # Print object counts to console
    if count_dict:
